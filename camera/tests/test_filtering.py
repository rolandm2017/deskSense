...
def test_three_sec_of_motion():
    ...
    black_filtered_path = filter_with_black(out, motion_frames)

    # play_video(black_filtered_path)
    # print("139ru")

    # start_frames = extract_frames(input_path)
    # result = extract_frames(black_filtered_path)
