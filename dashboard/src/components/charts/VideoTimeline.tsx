...
const VideoTimeline: React.FC<VideoTimelineProps> = ({
    ...
    useEffect(() => {
        ...
        days.forEach((day: VideoUsageTimeline) => {
            ...
            const programsSortedByMostTabbedInto = [...day.videos].sort(
            ...
            topFive.forEach(
                (video: VideoTimelineContent, programIndex: number) => {
                    // if (!video.programName.includes("Windows")) {
                    //     return;
                    // }
                    // Aggregate events before visualization
                    // FIXME: they're strings before this, but the type says Date, fix the lie
                    const eventsButTheyreRealDates: VideoTimelineEvent[] =
                        video.events.map((event: VideoTimelineEvent) => {
                            return {
                                logId: event.logId,
                    ...
                    // .filter((event: VideoTimelineEvent) => {
                    ...
                    aggregatedEvents.forEach((event: VideoTimelineEvent) => {
                    ...
                    aggregatedEvents.forEach((event: VideoTimelineEvent) => {
                        ...
                        if (durationMs < 0) {
                            ...
                            console.log(video.videoName, event.logId);
        ...
        console.log(longestDurationVideo);
