...
from activitytracker.arbiter.netflix_title_resolver import NetflixMysteryTitleResolver
...
class ActivityRecorder:
    def __init__(
        ...
        self.netflix_title_resolver = NetflixMysteryTitleResolver(
            mystery_media_dao,
            video_summary_dao.find_netflix_media_by_id,
            video_summary_dao.update_name_for_mystery,
            video_logging_dao.update_name_for_mystery,
        )
