...
from surveillance.src.util.time_formatting import (
    convert_to_utc, 
...
class FindTodaysEntryInitializer:
    def __init__(self, session_start_time: UserLocalTime) -> None:
        ...
        self.start_of_day_with_tz = datetime.combine(date_for_day, time.min, tzinfo=date_for_day.tzinfo)
        self.end_of_day_with_tz = datetime.combine(date_for_day, time.max, tzinfo=date_for_day.tzinfo)