...
class SurveillanceManager:
    def __init__(self, db_conn, shutdown_signal=None):
        ...
        mouse_facade = UbuntuMouseApiFacadeCore()  # TODO: choose the mouseApi facade based on OS
        ...
        self.keyboard_tracker = KeyboardTrackerCore(clock, keyboard_facade, self.handle_keyboard_ready_for_db)
        self.mouse_tracker = MouseTrackerCore(clock, mouse_facade, self.handle_mouse_ready_for_db)
        self.program_tracker = ProgramTrackerCore(clock, program_facade, self.handle_program_ready_for_db)
